...
const translations = {
  en: {
    ...
    portfolio: {
      ...
      projects: [
        ...
        { title: 'Commodities Trading Desk', category: 'Trading', description: 'Expansion of trading operations, Seeking local businesses to fund solar and agricultural programs, business can email irismonde1711@gmail for details.', status: 'WIP' },
    ...
    irisMonde: {
      ...
      heroTitle: 'Iris Monde',
      heroTagline: 'Governance Team — Expertise. Decision Making. Outcomes.',
      heroDescription:
        'An integrated expertise across Tax, Finance, Insurance and Logistics, delivered in partnership with Go Baraka Sarl.',
      introEyebrow: 'Who We Are',
      introTitle: 'Expertise across Tax, Finance, Insurance & Logistics',
      introText:
        'Our Governance Team brings together experienced professionals across Tax, Finance, Insurance, and Logistics, providing integrated oversight, risk management, compliance support, and strategic guidance. By connecting these disciplines, we help businesses strengthen governance, improve decision-making, manage risk, and operate with greater confidence.',
      pillarsEyebrow: 'Governance Team',
      pillarsTitle: 'Four disciplines, one governance model',
      pillarsSubtitle: 'Expertise. Decision Making. Outcomes.',
      pillars: [
        {
          title: 'Tax',
          points: ['Tax strategy & compliance', 'Regulatory obligations', 'Tax risk management'],
        },
        {
          title: 'Finance',
          points: ['Financial management & controls', 'Reporting & governance', 'Financial risk'],
        },
        {
          title: 'Insurance',
          points: ['Risk & protection', 'Insurance solutions', 'Risk assessment'],
        },
        {
          title: 'Logistics',
          points: ['Supply chain & operations', 'Transport & distribution', 'Operational efficiency'],
        },
      ],
      trainingEyebrow: 'Capability Building',
      trainingTitle: 'Self-training in compliance & risk management',
      trainingText:
        'Iris Monde delivers risk management solutions across West Africa. Our self-training modules turn that practice into hands-on case studies your teams can work through at their own pace — tax, internal control, insurance, logistics and customs.',
      trainingButton: 'Open the training modules',
      contactEyebrow: 'Partnership Contact',
      contactTitle: 'Talk to the Governance Team',
      contactSubtitle:
        'Partnership, advisory mandate or training programme — tell us what you need and we will come back to you.',
      contactFormTitle: 'Send a partnership request',
      contactFormNote: 'Prefer the general enquiry form?',
      contactFormLink: 'Go to the Contact Us page',
      organisation: 'Company / Organisation',
      subjectLabel: 'Area of interest',
      subjects: ['Tax', 'Finance', 'Insurance', 'Logistics', 'Compliance training', 'Other'],
    },
    selfTraining: {
      eyebrow: 'Compliance Academy',
      heroTitle: 'Self-Training — Compliance & Risk Management',
      heroDescription:
        'Four practical pathways and sixteen case studies drawn from Senegalese, WAEMU and CIMA regulation. Work at your own pace, then reveal the expected answer and its legal references.',
      howEyebrow: 'How It Works',
      howTitle: 'Four steps per case study',
      howItWorks: [
        { title: 'Pick a pathway', description: 'Tax team, junior staff, insurance, or logistics & customs.' },
        { title: 'Work the case', description: 'Read the scenario, review the data provided and follow the learner instructions.' },
        { title: 'Check your answer', description: 'Reveal the expected solution and the legal framework behind it.' },
        { title: 'Track your progress', description: 'Mark each case as completed — your progress is saved on this device.' },
      ],
      tracksEyebrow: 'Training Pathways',
      tracksTitle: 'Choose your pathway',
      scenarioLabel: 'Scenario',
      dataLabel: 'Data provided',
      instructionsLabel: 'Learner instructions (LMS)',
      solutionLabel: 'Expected solution & legal framework',
      showSolution: 'Show the expected solution',
      ...
      completedAll: 'Pathway completed — well done.',
      disclaimer:
        'Training material for internal use. The legal references reflect Senegalese, WAEMU and CIMA regulation and must be confirmed against the texts in force before any operational decision.',
      ctaTitle: 'Need the full programme for your team?',
      ctaText:
        'Iris Monde builds tailored compliance and risk-management programmes for organisations across West Africa.',
      ctaButton: 'Talk to the Governance Team',
    },
    statusLabels: {
  ...
  fr: {
    nav: {
      ...
      careers: 'Carrières',
      irisMonde: 'Iris Monde',
      selfTraining: 'Auto-formation',
      contact: 'Contactez-nous',
    },
    header: {
      switchLabel: 'EN',
      switchTitle: 'Passer à l’anglais',
      menuLabel: 'Plus de pages',
    },
    footer: {
    ...
    irisMonde: {
      ...
      heroTitle: 'Iris Monde',
      heroTagline: 'Équipe Gouvernance — Expertise. Décision. Résultats.',
      heroDescription:
        'Une expertise intégrée en Fiscalité, Finance, Assurance et Logistique, en partenariat avec Go Baraka Sarl.',
      introEyebrow: 'Qui sommes-nous',
      introTitle: 'Une expertise intégrée en Fiscalité, Finance, Assurance et Logistique',
      introText:
        'Notre équipe de gouvernance réunit des professionnels expérimentés dans les domaines de la fiscalité, de la finance, de l’assurance et de la logistique. Nous apportons une approche intégrée en matière de gouvernance, de gestion des risques, de conformité et de conseil stratégique afin d’aider les entreprises à prendre de meilleures décisions et à gérer leurs activités avec confiance.',
      pillarsEyebrow: 'Équipe Gouvernance',
      pillarsTitle: 'Quatre disciplines, un modèle de gouvernance',
      pillarsSubtitle: 'Expertise. Décision. Résultats.',
      pillars: [
        {
          title: 'Fiscalité',
          points: ['Stratégie fiscale & conformité', 'Obligations réglementaires', 'Gestion des risques fiscaux'],
        },
        {
          title: 'Finance',
          points: ['Gestion financière & contrôles', 'Reporting & gouvernance', 'Risque financier'],
        },
        {
          title: 'Assurance',
          points: ['Risque & protection', 'Solutions d’assurance', 'Évaluation des risques'],
        },
        {
          title: 'Logistique',
          points: ['Chaîne d’approvisionnement & opérations', 'Transport & distribution', 'Efficacité opérationnelle'],
        },
      ],
      trainingEyebrow: 'Renforcement des capacités',
      trainingTitle: 'Auto-formation en conformité et gestion des risques',
      trainingText:
        'Iris Monde déploie des solutions de gestion des risques en Afrique de l’Ouest. Nos modules d’auto-formation transforment cette pratique en études de cas concrètes que vos équipes peuvent traiter à leur rythme — fiscalité, contrôle interne, assurance, logistique et douane.',
      trainingButton: 'Ouvrir les modules de formation',
      contactEyebrow: 'Contact partenariat',
      contactTitle: 'Échanger avec l’équipe de gouvernance',
      contactSubtitle:
        'Partenariat, mission de conseil ou programme de formation — dites-nous ce dont vous avez besoin et nous revenons vers vous.',
      contactFormTitle: 'Envoyer une demande de partenariat',
      contactFormNote: 'Vous préférez le formulaire général ?',
      contactFormLink: 'Aller à la page Contactez-nous',
      organisation: 'Société / Organisation',
      subjectLabel: 'Domaine concerné',
      subjects: ['Fiscalité', 'Finance', 'Assurance', 'Logistique', 'Formation conformité', 'Autre'],
    },
    selfTraining: {
      eyebrow: 'Académie conformité',
      heroTitle: 'Auto-formation — Conformité & gestion des risques',
      heroDescription:
        'Quatre parcours pratiques et seize études de cas issues de la réglementation sénégalaise, UEMOA et CIMA. Travaillez à votre rythme, puis révélez la solution attendue et ses références juridiques.',
      howEyebrow: 'Mode d’emploi',
      howTitle: 'Quatre étapes par étude de cas',
      howItWorks: [
        { title: 'Choisir un parcours', description: 'Équipe fiscale, personnel junior, assurance ou logistique & douane.' },
        { title: 'Traiter le cas', description: 'Lire le scénario, examiner les données fournies et suivre les consignes apprenant.' },
        { title: 'Vérifier sa réponse', description: 'Révéler la solution attendue et le référentiel juridique correspondant.' },
        { title: 'Suivre sa progression', description: 'Marquer chaque cas comme terminé — la progression est enregistrée sur cet appareil.' },
      ],
      tracksEyebrow: 'Parcours de formation',
      tracksTitle: 'Choisissez votre parcours',
      scenarioLabel: 'Scénario',
      dataLabel: 'Données fournies',
      instructionsLabel: 'Consignes apprenant (LMS)',
      solutionLabel: 'Solution attendue & référentiel juridique',
      showSolution: 'Afficher la solution attendue',
      ...
      completedAll: 'Parcours terminé — bravo.',
      disclaimer:
        'Support de formation à usage interne. Les références juridiques renvoient à la réglementation sénégalaise, UEMOA et CIMA et doivent être confirmées au regard des textes en vigueur avant toute décision opérationnelle.',
      ctaTitle: 'Besoin du programme complet pour vos équipes ?',
      ctaText:
        'Iris Monde conçoit des programmes de conformité et de gestion des risques sur mesure pour les organisations d’Afrique de l’Ouest.',
      ctaButton: 'Échanger avec l’équipe de gouvernance',
    },
    statusLabels: {
      inProgress: 'En cours',
      completed: 'Terminé',
