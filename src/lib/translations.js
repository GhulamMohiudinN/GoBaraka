...
const translations = {
  en: {
    ...
    footer: {
      ...
      companySummary: 'A diversified business group committed to excellence and innovation across multiple sectors.',
    },
    hero: {
      label: 'What We Do',
      line1: 'Investing For',
    ...
    portfolio: {
      ...
      projects: [
        { title: 'Logistics Hub Expansion', category: 'Logistics', description: 'Development of a 10,000 sqm logistics center with advanced automation systems.', status: 'In Progress' },
        { title: 'Fleet Modernization Program', category: 'Transport', description: 'Investment in 50 new vehicles with GPS tracking and real-time monitoring.', status: 'Completed' },
        { title: 'Luxury Tourism Platform', category: 'Tourism', description: 'Digital platform for premium travel experiences and concierge services.', status: 'Launched' },
        { title: 'Commodities Trading Desk', category: 'Trading', description: 'Expansion of trading operations into new international markets.', status: 'In Progress' },
        { title: 'Digital Transformation Suite', category: 'Digital Services', description: 'Enterprise software solutions for business process automation.', status: 'Completed' },
        { title: 'Blockchain Investment Fund', category: 'Crypto', description: 'Strategic investment vehicle for blockchain and crypto assets.', status: 'Active' },
        ...
        { title: 'Regional Distribution Network', category: 'Transport', description: 'Expansion of distribution centers across key locations.', status: 'In Progress' },
        { title: 'Business Intelligence Platform', category: 'Digital Services', description: 'Data analytics platform for business insights.', status: 'Completed' },
      ],
    ...
    contact: {
      ...
      contactInfo: [
        { title: 'Address', details: ['Go Baraka Sarl', 'Business District', 'City, Country'], link: null },
  ...
  fr: {
    ...
    footer: {
      ...
      companySummary: 'Un groupe diversifié engagé dans l’excellence et l’innovation à travers plusieurs secteurs.',
    },
    hero: {
    ...
    portfolio: {
      ...
      projects: [
        ...
        { title: 'Programme de modernisation de la flotte', category: 'Transport', description: 'Investissement dans 50 nouveaux véhicules avec suivi GPS et surveillance en temps réel.', status: 'Terminé' },
        { title: 'Plateforme de tourisme de luxe', category: 'Tourisme', description: 'Plateforme numérique pour des expériences de voyage premium et des services de conciergerie.', status: 'Lancé' },
        { title: 'Bureau de commerce des matières premières', category: 'Commerce', description: 'Extension des opérations commerciales vers de nouveaux marchés internationaux.', status: 'En cours' },
        { title: 'Suite de transformation numérique', category: 'Services numériques', description: 'Solutions logicielles d’entreprise pour l’automatisation des processus métier.', status: 'Terminé' },
        { title: 'Fonds d’investissement blockchain', category: 'Crypto', description: 'Véhicule d’investissement stratégique pour les actifs blockchain et crypto.', status: 'Actif' },
        ...
        { title: 'Réseau de distribution régional', category: 'Transport', description: 'Extension des centres de distribution dans des emplacements clés.', status: 'En cours' },
        { title: 'Plateforme d’intelligence d’affaires', category: 'Services numériques', description: 'Plateforme d’analyse de données pour des insights métier.', status: 'Terminé' },
      ],
