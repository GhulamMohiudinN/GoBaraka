  ...
  en: {
    ...
    portfolio: {
      ...
      projects: [
        ...
        { title: 'Fleet Modernization Program', category: 'Transport', description: 'Investment in 50 new vehicles with GPS tracking and real-time monitoring.', status: 'Planned' },
        { title: 'Luxury Tourism Platform', category: 'Tourism', description: 'Digital platform for premium travel experiences and concierge services.', status: 'In Progress' },
